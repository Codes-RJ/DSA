...
```mermaid
flowchart TD
    N1["01_Introduction_to_Backtracking.md"]
    N2["02_Recursive_Backtracking.md"]
    N3["03_Pruning_Techniques.md"]
    N4["04_N_Queens.md"]
    N5["05_Sudoku_Solver.md"]
    N6["06_Rat_in_a_Maze.md"]
    N7["07_Knight_Tour.md"]
    N8["08_Generate_Parentheses.md"]
    N9["09_Subset_Generation.md"]
    N10["10_Permutation_Generation.md"]
    N11["11_Combination_Generation.md"]
    N12["12_Word_Search.md"]
    N13["13_Combination_Sum.md"]
    N14["14_Palindrome_Partitioning.md"]
    N15["15_M_coloring_Problem.md"]
    N16["16_Hamiltonian_Cycle.md"]
    N17["17_Tug_of_War.md"]
    N18["18_Crossword_Puzzle.md"]
    N19["19_Backtracking_vs_Brute_Force.md"]
    N20["20_Backtracking_vs_DP.md"]
    N21["Theory.md"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
