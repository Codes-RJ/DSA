...
```mermaid
flowchart TD
    N1["01_Friend_Functions_and_Classes.md"]
    N2["02_Mutable_Keyword.md"]
    N3["03_Explicit_Keyword.md"]
    N4["04_Virtual_Base_Class.md"]
    N5["05_Object_Slicing.md"]
    N6["06_Covariant_Return_Types.md"]
    N7["07_Placement_New.md"]
    N8["08_Type_Conversion_in_OOP.md"]
    N9["Theory.md"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
...
- Go to [01_Friend_Functions_and_Classes.md](01_Friend_Functions_and_Classes.md) to understand Friend Functions and Classes.
