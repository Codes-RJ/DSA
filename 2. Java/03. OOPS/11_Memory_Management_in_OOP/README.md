...
```mermaid
flowchart TD
    N1["01_New_and_Delete.md"]
    N2["02_New_Delete_for_Objects.md"]
    N3["03_Placement_New.md"]
    N4["04_Memory_Pools.md"]
    N5["05_Smart_Pointers_Intro.md"]
    N6["Theory.md"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
...
- Go to [01_New_and_Delete.md](01_New_and_Delete.md) to understand New and Delete.
