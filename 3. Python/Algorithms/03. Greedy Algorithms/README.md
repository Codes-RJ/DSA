...
```mermaid
flowchart TD
    N1["01_Introduction_to_Greedy.md"]
    N2["02_Activity_Selection.md"]
    N3["03_Job_Sequencing.md"]
    N4["04_Fractional_Knapsack.md"]
    N5["05_Huffman_Coding.md"]
    N6["06_Coin_Change_Greedy.md"]
    N7["07_Minimum_Number_of_Platforms.md"]
    N8["08_Interval_Scheduling.md"]
    N9["09_Interval_Partitioning.md"]
    N10["10_Dijkstra_Algorithm.md"]
    N11["11_Prim_Algorithm.md"]
    N12["12_Kruskal_Algorithm.md"]
    N13["13_Minimum_Cost_to_Connect_Sticks.md"]
    N14["14_Gas_Station_Problem.md"]
    N15["15_Lexicographically_Smallest_Sequence.md"]
    N16["16_Maximum_Sum_after_K_Negations.md"]
    N17["17_Candy_Distribution.md"]
    N18["18_Jump_Game.md"]
    N19["19_Assign_Cookies.md"]
    N20["20_Reconstruct_String_from_Adjacent_Pairs.md"]
    N21["21_Proof_of_Optimality.md"]
    N22["Theory.md"]
    N1 --> N2
    N2 --> N3
    N3 --> N4
