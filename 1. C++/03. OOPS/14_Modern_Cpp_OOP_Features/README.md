# Modern C++ Language Features Used by Class Designs

This folder now contains only lessons that are not canonical elsewhere. Each page must declare the language standard required by its examples.

## Study Order

1. [`auto` and `decltype`](01_Auto_and_Decltype.md)
...
Continue to [Projects and Applications](../15_Projects_and_Applications/README.md).
